...
static mut NAMED_WILDCARD_SYMBOL: TSSymbol = (65535 as os::raw::c_int - 1 as os::raw::c_int) as TSSymbol;
...
unsafe extern "C" fn capture_list_pool_reset(mut self_0: *mut CaptureListPool, mut list_size: u16) {
    ...
    let mut total_size: u32 = (MAX_STATE_COUNT as os::raw::c_int * list_size as os::raw::c_int) as u32;
    array__reserve(
        &mut (*self_0).list as *mut TSQueryCaptureArray as *mut VoidArray,
        ::std::mem::size_of::<TSQueryCapture>() as os::raw::c_ulong,
        total_size,
    );
...
unsafe extern "C" fn symbol_table_insert_name(
    ...
    array__grow(
        ...
        ::std::mem::size_of::<os::raw::c_char>() as os::raw::c_ulong,
    );
    memset(
        (*self_0)
            .characters
        ...
        (length.wrapping_add(1 as os::raw::c_int as os::raw::c_uint) as usize)
            .wrapping_mul(::std::mem::size_of::<os::raw::c_char>() as usize),
    );
    ...
    *(*self_0).characters.contents.offset(
    ...
    array__grow(
        ...
        ::std::mem::size_of::<Slice>() as os::raw::c_ulong,
    );
...
unsafe extern "C" fn symbol_table_insert_name_with_escapes(
    ...
    array__grow(
        &mut (*self_0).characters as *mut SymbolTableCharacters as *mut VoidArray,
        escaped_length.wrapping_add(1 as os::raw::c_int as os::raw::c_uint) as size_t,
        ::std::mem::size_of::<os::raw::c_char>() as os::raw::c_ulong,
    );
    memset(
        (*self_0)
    ...
    while i < 4 as os::raw::c_int as os::raw::c_uint {
        if (*self_0).capture_ids[i as usize] as os::raw::c_int == capture_id as os::raw::c_int {
            ...
            while i.wrapping_add(1 as os::raw::c_int as os::raw::c_uint)
                < 4 as os::raw::c_int as os::raw::c_uint
            {
                if (*self_0).capture_ids[i.wrapping_add(1 as os::raw::c_int as os::raw::c_uint) as usize]
                    as os::raw::c_int
                ...
                (*self_0).capture_ids[i.wrapping_add(1 as os::raw::c_int as os::raw::c_uint) as usize] =
                    NONE;
                i = i.wrapping_add(1)
            }
            break;
...
unsafe extern "C" fn ts_query__pattern_map_insert(
    ...
    array__splice(
        ...
        ::std::mem::size_of::<PatternEntry>() as os::raw::c_ulong,
        index,
...
unsafe extern "C" fn ts_query__finalize_steps(mut self_0: *mut TSQuery) {
    ...
    while i < (*self_0).steps.size {
        ...
        if (*step).capture_ids[0 as os::raw::c_int as usize] as os::raw::c_int != NONE as os::raw::c_int {
            ...
            while j < (*self_0).steps.size {
                ...
                if (*s).capture_ids[0 as os::raw::c_int as usize] as os::raw::c_int != NONE as os::raw::c_int
                {
                    (*step).set_contains_captures(1 as os::raw::c_int != 0)
                }
                j = j.wrapping_add(1)
        ...
        if (*stream).next == ')' as i32 {
                ...
                < (*self_0).predicates_by_pattern.size
            {
                ...
                __assert_fail(b"(u32)(&self->predicates_by_pattern)->size - 1 < (&self->predicates_by_pattern)->size\x00"
                              ...
                              b"lib/src/query.c\x00" as *const u8 as
                                  *const os::raw::c_char,
                              546 as os::raw::c_int as os::raw::c_uint,
                              (*::std::mem::transmute::<&[u8; 60],
                                                        &[os::raw::c_char; 60]>(b"TSQueryError ts_query__parse_predicate(TSQuery *, Stream *)\x00")).as_ptr());
            }
            ...
            *fresh3 = (*fresh3).wrapping_add(1);
            array__grow(
                ...
                1 as os::raw::c_int as size_t,
                ::std::mem::size_of::<TSQueryPredicateStep>() as os::raw::c_ulong,
            );
            ...
            if (*stream).next == '@' as i32 {
                    ...
                    < (*self_0).predicates_by_pattern.size
                {
                    ...
                    __assert_fail(b"(u32)(&self->predicates_by_pattern)->size - 1 < (&self->predicates_by_pattern)->size\x00"
                                  ...
                                  b"lib/src/query.c\x00" as *const u8 as
                                      *const os::raw::c_char,
                                  575 as os::raw::c_int as os::raw::c_uint,
                                  (*::std::mem::transmute::<&[u8; 60],
                                                            &[os::raw::c_char; 60]>(b"TSQueryError ts_query__parse_predicate(TSQuery *, Stream *)\x00")).as_ptr());
                }
                ...
                *(*self_0).predicate_steps.contents.offset(fresh6 as isize) = {
                ...
                loop {
                    ...
                    if !stream_advance(stream) {
                        stream_reset(stream, string_content.offset(-(1 as os::raw::c_int as isize)));
                        return TSQueryErrorSyntax;
                    }
                }
                ...
                *(*self_0).predicate_steps.contents.offset(fresh8 as isize) = {
                    ...
                    < (*self_0).predicates_by_pattern.size
                {
                    ...
                    __assert_fail(b"(u32)(&self->predicates_by_pattern)->size - 1 < (&self->predicates_by_pattern)->size\x00"
                                  ...
                                  b"lib/src/query.c\x00" as *const u8 as
                                      *const os::raw::c_char,
                                  635 as os::raw::c_int as os::raw::c_uint,
                                  (*::std::mem::transmute::<&[u8; 60],
                                                            &[os::raw::c_char; 60]>(b"TSQueryError ts_query__parse_predicate(TSQuery *, Stream *)\x00")).as_ptr());
                }
    ...
    if (*stream).next == ')' as i32 {
        ...
        if (*stream).next == '(' as i32 {
            ...
            array__grow(
                ...
                1 as os::raw::c_int as size_t,
                ::std::mem::size_of::<QueryStep>() as os::raw::c_ulong,
            );
...
pub unsafe extern "C" fn ts_query_new(
    ...
    if ts_language_version(language) >= 11 as os::raw::c_int as os::raw::c_uint {
        ...
        symbol_map = ts_malloc(
            (::std::mem::size_of::<TSSymbol>() as os::raw::c_ulong)
                .wrapping_mul(symbol_count as os::raw::c_ulong),
        ) as *mut TSSymbol;
        let mut i: os::raw::c_uint = 0 as os::raw::c_int as os::raw::c_uint;
    ...
    let mut self_0: *mut TSQuery =
        ts_malloc(::std::mem::size_of::<TSQuery>() as os::raw::c_ulong) as *mut TSQuery;
    *self_0 = {
    ...
    while stream.input < stream.end {
        ...
        array__grow(
            &mut (*self_0).start_bytes_by_pattern as *mut TSQueryStartBytesByPattern
                as *mut VoidArray,
            1 as os::raw::c_int as size_t,
            ::std::mem::size_of::<u32>() as os::raw::c_ulong,
        );
...
pub unsafe extern "C" fn ts_query_cursor_new() -> *mut TSQueryCursor {
    let mut self_0: *mut TSQueryCursor =
        ts_malloc(::std::mem::size_of::<TSQueryCursor>() as os::raw::c_ulong) as *mut TSQueryCursor;
    *self_0 = {
    ...
    array__reserve(
        ...
        ::std::mem::size_of::<QueryState>() as os::raw::c_ulong,
    ...
    *(*self_0).states.contents.offset(fresh19 as isize) = *state;
        ...
        < (*self_0).states.size
    {
        ...
        __assert_fail(
            ...
            b"lib/src/query.c\x00" as *const u8 as *const os::raw::c_char,
            1208 as os::raw::c_int as os::raw::c_uint,
            (*::std::mem::transmute::<&[u8; 77], &[os::raw::c_char; 77]>(
...
unsafe extern "C" fn ts_query_cursor__advance(mut self_0: *mut TSQueryCursor) -> bool {
    loop {
        if (*self_0).ascending {
            ...
            (*self_0).states.size =
                ((*self_0).states.size as os::raw::c_uint).wrapping_sub(deleted_count) as u32 as u32;
                ...
                || point_lte(ts_node_end_point(node), (*self_0).start_point) as os::raw::c_int != 0
            {
                ...
                if (*self_0).end_byte <= ts_node_start_byte(node)
                    || point_lte((*self_0).end_point, ts_node_start_point(node)) as os::raw::c_int != 0
                {
                    return 0 as os::raw::c_int != 0;
                }
                ...
                while i_2 < n_0 {
                        ...
                        != (*self_0).depth)
                    {
                        ...
                        let mut node_does_match: bool = (*step_2).symbol as os::raw::c_int
                            ...
                            || (*step_2).symbol as os::raw::c_int == WILDCARD_SYMBOL as os::raw::c_int
...
pub unsafe extern "C" fn ts_query_cursor_next_match(
    ...
    let mut state: *mut QueryState = &mut *(*self_0)
        .finished_states
        .contents
        .offset(0 as os::raw::c_int as isize) as *mut QueryState;
    (*match_0).id = (*state).id;
