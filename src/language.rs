...
pub unsafe extern "C" fn ts_language_table_entry(
            ...
            == -(1 as os::raw::c_int) as TSSymbol as os::raw::c_int - 1 as os::raw::c_int
    {
        ...
        if (symbol as os::raw::c_uint) < (*self_0).token_count {
        } else {
            __assert_fail(b"symbol < self->token_count\x00" as *const u8 as
                              *const os::raw::c_char,
                          b"lib/src/language.c\x00" as *const u8 as
                              *const os::raw::c_char,
                          33 as os::raw::c_int as os::raw::c_uint,
                          (*::std::mem::transmute::<&[u8; 84],
                                                    &[os::raw::c_char; 84]>(b"void ts_language_table_entry(const TSLanguage *, TSStateId, TSSymbol, TableEntry *)\x00")).as_ptr());
        }
